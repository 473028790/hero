...
static Packet_t *RxPkt;
 ...
 /**
 * @brief  ³õʼ»¯׋̬½₫ģ¿銠* @note   ͪ³ɳõʼ»¯һ¸öҽ½Ņ䖃
 * @param  pkt ½ӊհüָի
 * @param  ½ӊճɹ¦»ص÷º¯ʽ
 * @code
 ...
 *      {
 *          pkt->buf Ϊʽ¾ݠpkt->payload_len Ϊ½ӊյ½µėֽڳ¤¶Ƞ
 *      }
 *
 *      Packet_t pkt;
...
{
    EventHandler = Func;
    memset(pkt, 0, sizeof(Packet_t));  //ǥÁ㊠   
		RxPkt = pkt;
}

 /**
 * @brief  ½ӊՉMUʽ¾݊ * @note   Ԛ´®¿ڽӊՖжϖе÷Ӄ´˺¯ʽ
 * @param  c ´®¿ڊý¾݊ * @retval CH_OK
 */
